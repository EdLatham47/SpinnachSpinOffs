...
%gaussleg.m for magic stuff to do with linewidth calculating.
    ...
    parameters.Bw=1; %Hz https://spindynamics.org/wiki/index.php?search=parameters.Bw&title=Special%3ASearch&go=Go
    % Sweep width in each dimension of the spectrum (Hz). - RESOLVED
    parameters.sweep = 1e9;     % Width of Sweep for First Figure.
    % Linewidth?
    ...
    parameters.pulse_frq=[10.3e9 10.3e9 10.3e9];
    %        GAPS BETWEEN PULSES
