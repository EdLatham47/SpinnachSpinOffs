...
function SoftStates_Plots2(spin_system,parameters)
    ...
    fids=powder(spin_system,@SoftStates_Pulses3,parameters,parameters.assumptions);
    ...
    % Get DEER echo stack
    echo_stack=powder(spin_system,@SoftStates_Pulses3,parameters,parameters.assumptions);
