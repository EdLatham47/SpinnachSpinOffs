...
%    K  - kinetics superoperator, received from context function - does chemical reactions, 
%                                   i dont think this is needed and can be croppepd out in powder
% Outputs:
...
function echo_stack=SoftStates_Pulses3(spin_system,parameters,H,R,K)
    % Check consistency - at the bottom, 
    grumble(spin_system,parameters,H,R,K);
    % Compose Liouvillian - may just delet the K term to eliminate chemical reactions (kinetics)
    L=H+1i*R+1i*K;
