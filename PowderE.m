...
%                       using the full anisotropic Hamiltonian at each
%                       orientation in the powder, and sent to the pul-
%                       se sequence in parameters.rho0 subfield
%
...
function answer=PowderE(spin_system,pulse_sequence,parameters,assumptions)
